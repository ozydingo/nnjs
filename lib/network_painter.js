...
NetworkPainter.prototype = {
  ...
  paint_axon: function(layer, to_index, from_index) {
    ...
    if (weight > 0) {
      var red = math.round(255 * (2 * nnjs_functions.sigmoid(5 * weight) - 1));
      var blue = 0;
    } else {
      var red = 0;
      var blue = math.round(255 * (2 * nnjs_functions.sigmoid(-5 * weight) - 1));
    }
    ...
    line.setAttribute('style', 'stroke:rgb(' + red + ',0,' + blue + ');stroke-width:1');
  },
