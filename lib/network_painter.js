...
NetworkPainter.prototype = {
  ...
  paint_axon: function(layer, to_index, from_index) {
    ...
    var nx0 = this.neuron_x(layer, from_index);
    var ny0 = this.neuron_y(layer, from_index);
    var nx1 = this.neuron_x(layer - 1, to_index);
    var ny1 = this.neuron_y(layer - 1, to_index);
