...
nnjs.NetworkPainter.prototype = {
  ...
  coef_color: function(coef) {
    if (coef > 0) {
      var red = this.color_partial(coef, 215, 110);
      var green = this.color_partial(coef, 215, 60);
      var blue = this.color_partial(coef, 215, 170);
    } else {
      var red = this.color_partial(coef, 215, 200);
      var green = this.color_partial(coef, 215, 230);
      var blue = this.color_partial(coef, 215, 50);
    }
